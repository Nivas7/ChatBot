...
const Login = () => {
    return ( 
        <div className="h-screen flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-[1rem] text-center text-xs tracking-widest italic text-gray-200 leading-relaxed cursor-default"><span className="text-blue-600">Carla :{" "}</span>The Chatbot that wont&apos;t drive you crazy&hellip;  well 	&sbquo; at least not intentionally!</p>
