    ...
    return ( 
        <div>
          <div>
            ...
            <p className="lg:m-24 md:text-base lg:mx-[20vw] text-gray-400 text-center text-sm lg:text-xl  px-[1rem] m-[2rem]">Welcome to Carla&sbquo; your virtual assistant! Whether you&apos;re a  enthusiast&sbquo; or just looking for information about the Machine learning we&apos;re here to help you. Carla is your go to chatbot for all things automation.</p>

          </div>
          <button className="bg-blue-800 w-[30vh] md:ml-[30%] lg:ml-[40%] p-[1rem] ml-[20%]  rounded-lg" onClick={() => {
            router.push("Chat")
